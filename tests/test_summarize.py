...
real_pdf = open("/usr/share/cups/data/form_english.pdf", "rb").read()
pdf_txt = router._upload_text("form.pdf", real_pdf)
check("pdf extracts real text", "TASK INFORMATION" in pdf_txt, pdf_txt[:60])
